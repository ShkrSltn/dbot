...
def display_auth():
    ...
    if not st.session_state.authenticated:
        # Create centered layout with 60% width
        ...
        with col2:
            ...
            # Create header row with tabs and demo button
            tab_col, demo_col = st.columns([0.7, 0.3])
            ...
            with demo_col:
                ...
                st.markdown("### Try DigiBot")
                st.markdown("No account needed - create a demo account to explore the features:")
        ...
        # Show logged in state - also center this section
        col1, col2, col3 = st.columns([0.2, 0.6, 0.2])
